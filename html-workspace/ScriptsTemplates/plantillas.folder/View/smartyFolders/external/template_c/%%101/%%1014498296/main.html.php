<?php /* Smarty version 2.6.1, created on 2013-11-14 00:49:43
	...
	<body class="home">
		...
		<header>
			...
			<li><img id="lengEng" src="../img/Flags/UnitedKingdom_Flag.png" width="24" height="24"></li>
				...
				<div id="logo">
					<a href="../Controller/main.php?action=FormMain&lenguage=SPA"><img  src="../img/logo.png" alt="Simpler"></a>
				</div>
				
				<!-- nav -->
				<ul id="nav" class="sf-menu">
					<li class="current-menu-item"><a href="../Controller/main.php?action=FormMain&lenguage=SPA"><?php echo $this->_tpl_vars['title_01']; ?>
</a></li>
					<li><a href="../View/templates/blog.html"><?php echo $this->_tpl_vars['title_02']; ?>
</a></li>
					<li><a href="page.html"><?php echo $this->_tpl_vars['title_03']; ?>
</a>
						<ul>
							<li><a href="../View/templates/page-elements.html"><?php echo $this->_tpl_vars['title_03_01']; ?>
</a></li>
							<li><a href="../View/templates/page-icons.html"><?php echo $this->_tpl_vars['title_03_02']; ?>
</a></li>
							<li><a href="../View/templates/page-typography.html"><?php echo $this->_tpl_vars['title_03_03']; ?>
</a></li>
						</ul>
					</li>
					<li><a href="../View/templates/portfolio.html"><?php echo $this->_tpl_vars['title_04']; ?>
</a></li>
					<li><a href="../View/templates/contact.html"><?php echo $this->_tpl_vars['title_05']; ?>
</a></li>
				</ul>
		...
		<div id="main">
			...
			<div class="home-featured">
				...
				<ul id="filter-buttons">
					<li><a href="#" data-filter="*" class="selected"><?php echo $this->_tpl_vars['detail_01_01']; ?>
</a></li>
					<li><a href="#" data-filter=".web"><?php echo $this->_tpl_vars['detail_01_02']; ?>
</a></li>
					<li><a href="#" data-filter=".print"><?php echo $this->_tpl_vars['detail_01_03']; ?>
</a></li>
					<li><a href="#" data-filter=".design"><?php echo $this->_tpl_vars['detail_01_04']; ?>
</a></li>
					<li><a href="#" data-filter=".photo"><?php echo $this->_tpl_vars['detail_01_05']; ?>
</a></li>
				</ul>
